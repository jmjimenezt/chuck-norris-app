...
class SearchResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search_result" do
    assert_difference('SearchResult.count') do
      post search_results_url, params: { search_result: { categories: @search_result.categories, email: @search_result.email, keywords: @search_result.keywords, random: @search_result.random } }
    end
  ...
  test "should update search_result" do
    patch search_result_url(@search_result), params: { search_result: { categories: @search_result.categories, email: @search_result.email, keywords: @search_result.keywords, random: @search_result.random } }
