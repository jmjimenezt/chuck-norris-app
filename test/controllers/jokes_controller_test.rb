...
class JokesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joke" do
    assert_difference('Joke.count') do
      post jokes_url, params: { joke: { categories: @joke.categories, icon_url: @joke.icon_url, url: @joke.url, value: @joke.value } }
    end
  ...
  test "should update joke" do
    patch joke_url(@joke), params: { joke: { categories: @joke.categories, icon_url: @joke.icon_url, url: @joke.url, value: @joke.value } }
